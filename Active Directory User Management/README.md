<img width="767" height="607" alt="Screenshot 2026-06-13 at 00 02 54" src="https://github.com/user-attachments/assets/6cb4bcab-abd2-4061-81ec-33a7397d0439" />Overview:
...
Screenshot 5 – Password Reset & Account Enable:

Use:

Seventh image (Set-ADAccountPassword + Enable-ADAccount + Enabled=True)
...
Sixth image (Windows 10 desktop after login)
...
Screenshot 7 – Configure Lockout Policy:

Use:

Last image (net accounts /lockoutthreshold:3)
